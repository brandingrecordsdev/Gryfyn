    ...
    <>
      ...
      <LandingPageSection classes={"footer-description"}>
        ...
        <div className="scroll-box font-['basier_circle']">
          ...
          <br />
          <h6 className="block font-['basier_circle_semibold']">Measurement</h6>
          <p>
          ...
          <Accordion
            ...
            toggleExpand={() => {
              setAnalyticsExpanded((state) => !state);
            }}
            tag={"section"}
            heading={"Analytics"}
            body={
              <>
                ...
                <br />
                <h6 className="block font-['basier_circle_semibold']">
                  Google Analytics (Google LLC)
                </h6>
                <br />
                <p>
                  Google Analytics is a web analysis service provided by Google
                  LLC (&quot;Google&quot;). Google utilizes the Data collected
          ...
          <br />
          <p>Gryfyn Global Limited</p>
          <br />
          <p>
            <span className="font-['basier_circle_semibold']">
              Owner contact email:
            </span>{" "}
            info@gryfyn.io
          </p>
            ...
            body={
              <>
                ...
                <p>
                  ...
                  answer (successful outcome, error, etc.), the country of
                  origin, the features of the browser and the operating system
                  utilized by the User, the various time details per visit
                  (e.g., the time spent on each page within the Application) and
                  the details about the path followed within the Application
                  with special reference to the sequence of pages visited, and
                  other parameters about the device operating system and/or the
                  User&apos;s IT environment.
                </p>
                <br />
                <h6 className="block font-['basier_circle_semibold']">User</h6>
                <br />
                <p>
        ...
        <div className="flex flex-col items-center content-center justify-center">
          <span className="privacy-sub font-['neue_metana_regular'] text-center">
            i am your&nbsp;<b className="font-['neue_metana_bold']">wallet.</b>
          </span>
          <span className="font-['basier_circle']">
